...
<div class="nf-hud-tag">NETFORGE // LABS &bull; အဆင့်မြင့် ကွန်ရက်အင်ဂျင်နီယာ လက်တွေ့လေ့ကျင့်ရေးစခန်း</div>

# NETFORGE LABS (မြန်မာဗားရှင်း)

**ကွန်ရက်နည်းပညာကို လက်တွေ့ကိုယ်တိုင် တည်ဆောက်ရင်း လေ့လာပါ။** Arista cEOS စနစ်များပေါ်တွင် Real-World Network Fabrics များကို တည်ဆောက်ပါ၊ စနစ်များကို ရည်ရွယ်ချက်ရှိရှိ ပြိုလဲစမ်းသပ်ပါ (break it on purpose)၊ Configuration တစ်ကြောင်းချင်းစီ၏ နောက်ကွယ်ရှိ အရေးပါပုံ (*why*) ကို သဲသဲကွဲကွဲ နားလည်စေမည်။

မိမိတက်လှမ်းလိုသည့် အင်ဂျင်နီယာ အထူးပြုလမ်းကြောင်းများကို စိတ်ကြိုက်ရွေးချယ်လေ့လာနိုင်ပါသည် - **AI & Hyperscale Architecture**၊ **Network SRE & Observability**၊ **Cybersecurity & DevSecOps**၊ **NetDevOps**၊ **Low-Latency Finance**၊ သို့မဟုတ် **TPM System Design**။

<p class="nf-hero-meta">ARISTA cEOS &bull; CONTAINERLAB &bull; MACOS ORBSTACK & LINUX DOCKER တွင် ၁၀၀% အခမဲ့ စမ်းသပ်နိုင်သည်</p>
...
-   🌐 **Network for AI & Hyperscale Architect** &nbsp; <span class="nf-badge ok">၄၀–၅၀ နာရီ</span>

    ---

    Non-blocking AI training fabrics (RoCEv2, PFC, ECN)၊ 5-Stage BGP Clos (RFC 7938)၊ MPLS/SR-MPLS Ti-LFA နှင့် EVPN-VXLAN ESI multihomed clusters စနစ်များ။

    [AI Architect လမ်းကြောင်းသို့ →](tracks/network-engineer.md)

-   🤖 **Network SRE & Observability** &nbsp; <span class="nf-badge ok">၃၀–၃၅ နာရီ</span>
...
## 🚀 လက်တွေ့စမ်းသပ်နိုင်သော သင်ရိုးများနှင့် Lab Matrix (Courses & Labs)
...
<div class="nf-hud-tag">// NETFORGE LABS PHILOSOPHY</div>

> **အယူအဆ (Mental Model) → ဘာကြောင့်သုံးရသလဲ (Why before How) → Protocol ဖွဲ့စည်းပုံ → လက်တွေ့တည်ဆောက်ခြင်း → စနစ်မှန်ကန်ကြောင်း အတည်ပြုခြင်း → စနစ်ကို ချို့ယွင်းအောင်ဖျက်စစ်ခြင်း (Break it) → အင်တာဗျူး အမေးအဖြေ လေ့ကျင့်ခြင်း။**
