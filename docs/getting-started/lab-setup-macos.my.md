...
## အဆင့် ၈ · Lab ကို သန့်ရှင်းစွာ ပြန်လည် ဖျက်သိမ်းခြင်း (Destroy & Cleanup)

လက်တွေ့ စမ်းသပ်လေ့ကျင့်မှု ပြီးဆုံးသည့်အခါ (သို့မဟုတ် စနစ်ကို အစမှ ပြန်လည်စတင်လိုသည့်အခါ) Containerlab ၏ `destroy` command ဖြင့် မိမိစက်တွင်းရှိ lab ကို သန့်ရှင်းစွာ ပြန်လည်ဖျက်သိမ်းပေးနိုင်ပါသည်:

### ၁။ သက်ဆိုင်ရာ Lab တစ်ခုတည်းကိုသာ ဖျက်သိမ်းနည်း:
```bash
sudo containerlab destroy -t ceos-evpn.clab.yml
```
ဤ command သည် topology ဖိုင်ထဲတွင် သတ်မှတ်ထားသော containers များ၊ virtual ethernet (veth) ကြိုးများ၊ `/etc/hosts` နှင့် SSH configuration များကို စနစ်တကျ အလိုအလျောက် သန့်ရှင်းဖယ်ရှားပေးပါသည်။

### ၂။ ကျန်နေသော container ဟောင်းများအားလုံးကို အမြစ်ပြတ် ရှင်းထုတ်နည်း:
အကယ်၍ ယခင် lab အဟောင်းများမှ မေ့ကျန်နေခဲ့သော containerlab စနစ်အားလုံးကို တစ်ပြိုင်နက် အပြီးတိုင် ဖယ်ရှားလိုပါက `--all` flag ကို အသုံးပြုနိုင်ပါသည်:
```bash
sudo containerlab destroy --all
```

### ၃။ Config ဖိုင်များနှင့် lab directory ပါ တစ်ပါတည်း အပြီးရှင်းထုတ်နည်း:
```bash
sudo containerlab destroy -t ceos-evpn.clab.yml --cleanup
```
(`--cleanup` သို့မဟုတ် `-c` flag သည် lab လည်ပတ်စဉ် ဖန်တီးခဲ့သော `clab-ceos-evpn` ဖိုင်တွဲနှင့် node flash files များကိုပါ လုံးဝ ရှင်းလင်းပေးပါသည်)။

!!! tip "အဘယ်ကြောင့် လေ့ကျင့်ပြီးတိုင်း destroy ပြုလုပ်သင့်သလဲ"
    Switch ၄ လုံးပါသော cEOS fabric တစ်ခုသည် RAM 8 GB ခန့်နှင့် CPU စွမ်းအင်ကို အသုံးပြုထားပါသည်။ လေ့ကျင့်ပြီးဆုံးသည့်အခါ `destroy` လုပ်လိုက်ခြင်းဖြင့် မိမိ Mac ကွန်ပျူတာ၏ Memory နှင့် Battery စွမ်းအင်ကို ချက်ချင်း ပြန်လည်လွတ်လပ်သက်သာစေပြီး စက်မပူအောင် ထိန်းသိမ်းပေးပါသည်။
