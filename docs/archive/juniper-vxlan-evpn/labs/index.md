...
👉 **[Open the complete guide →](lab-01-fullmesh.md)**
...
👉 **[Open the complete guide →](lab-02-rr.md)**
...
👉 **[Open the complete guide →](lab-03-l3vni.md)** *(config pending live validation)*
...
👉 **[Open the complete guide →](lab-04-multitenancy.md)** *(pending live validation)*
...
👉 **[Open the complete guide →](lab-05-esi.md)** *(pending live validation)*
...
See the [Quickstart](../../../getting-started/team-quickstart.md) for the team workflow.
