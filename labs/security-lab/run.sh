#!/usr/bin/env bash
# ==============================================================================
# NetForge Labs — Automated Step Runner & Verifier (Phase 8 Security)
# ==============================================================================
set -euo pipefail
...
STEPS=(
  "01:Control Plane Policing (CoPP) & CPU Protection"
)
...
run_guided_step() {
  ...
  echo "    docker exec -it ${FABRIC}-leaf1 Cli -p 15 -c \"show policy-map type copp\""
  echo ""
...
list_steps() {
  echo "Available steps in security-lab:"
...
case "$1" in
  ...
  --all|-a)
    ...
    echo ""
    echo "All security pipeline steps passed cleanly!"
    ;;
  *)
